...
public class ProstorTest
{
    ...
    public void testInsertItems(){
        Prostor prostortest = new Prostor("test1","hah","loreroomky");
        QuestItem questItem1 = new QuestItem("test1");
        prostortest.insertItem(questItem1);
        assertEquals(true,prostortest.itemInRoom("test1"));
    }
}
